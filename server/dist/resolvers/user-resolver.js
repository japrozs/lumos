...
let UserResolver = class UserResolver {
    ...
    async updateCollegeList(collegeList, { req }) {
        await user_1.User.update({ id: req.session.userId }, {
            collegeList,
        });
        return true;
    }
    async updateTasks(tasks, { req }) {
        await user_1.User.update({ id: req.session.userId }, {
            tasks,
        });
        return true;
...
__decorate([
    (0, type_graphql_1.UseMiddleware)(is_auth_1.isAuth),
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)("collegeList")),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], UserResolver.prototype, "updateCollegeList", null);
__decorate([
    (0, type_graphql_1.UseMiddleware)(is_auth_1.isAuth),
    (0, type_graphql_1.Mutation)(() => Boolean),
    __param(0, (0, type_graphql_1.Arg)("tasks")),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], UserResolver.prototype, "updateTasks", null);
